...
<div id="container">
    ...
    <div class="menu">
        ...
        <div class="linkbox">
            ...
            <a href="form.php?zes=2" class="link">2</a>

        </div>

        <div class="linkbox">

            <a href="form.php?zes=3" class="link">3</a>

        </div>

        <div class="linkbox">

            <a href="form.php?zes=4" class="link">4</a>
        ...
        <div class="linkbox">
           ...
           <a href="scores.php" class="wyniki icon-trophy"></a>

        </div>

        <a class="about" href="css/license.txt">Entypo icon</a>
